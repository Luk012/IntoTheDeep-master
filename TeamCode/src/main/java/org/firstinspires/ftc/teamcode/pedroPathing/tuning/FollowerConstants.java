...
public class FollowerConstants {
    ...
    private static double xMovement = 50;
    private static double yMovement = 55;
    ...
    public static double mass = 11.82;
    ...
    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70;
    ...
    public static double pathEndVelocityConstraint = 0.5;
    ...
    // This can be custom set for each Path.
    public static double pathEndTranslationalConstraint = 0.75;

    // When the robot is at the end of its current Path or PathChain and the heading error goes
    // below this value, then end the Path. This is in radians.
    // This can be custom set for each Path.
    public static double pathEndHeadingConstraint = Math.toRadians(5);
